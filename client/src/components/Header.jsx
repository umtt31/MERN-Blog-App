...
function Header() {
  const [navIsVisible, setNavIsVisivle] = useState(false);

  const navVisibilityHandler = () => {
    setNavIsVisivle((curState) => {
      return !curState;
    });
  };
  ...
  return (
    <section>
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        >
          <ul className=" text-white gap-y-5 lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 items-center font-semibold ">
